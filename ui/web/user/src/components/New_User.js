...
function Register() {
    ...
    // On change the Input Value (username, name, email, password)
        ...
        <div className="_loginRegister">
            ...
            <form onSubmit={submitForm} noValidate>
                <div className="form-control">
                    ...
                    <input name="name" required type="text" value={state.userInfo.username} onChange={onChangeValue} placeholder="Enter your username" />
                </div>
                <div className="form-control">
                    <label>Name</label>
